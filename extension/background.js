...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
  if (request.action === "sync_to_synapseip") {
    ...
    fetch("https://synapseip-1ncu.onrender.com/api/sources", {
      method: "GET",
      cache: "no-store"
    })
    ...
    fetch("https://synapseip-1ncu.onrender.com/api/sources/bulk-delete", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
    ...
    fetch("https://synapseip-1ncu.onrender.com/api/report-change", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
function connectWebSocket() {
  const socket = new WebSocket('wss://synapseip-1ncu.onrender.com/ws');
...
function fetchSystemConfig() {
    fetch("https://synapseip-1ncu.onrender.com/api/config/selectors", { cache: "no-store" })
    .then(res => res.json())
    .then(data => {
